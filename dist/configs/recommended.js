...
module.exports = {
  ...
  rules: {
    ...
    'coffee/cyclomatic-complexity': ['error', {
      value: 10
    }],
    'coffee/indentation': ['error', {
      value: 1
    }],
    'coffee/line-endings': ['error', {
      value: 'unix'
    }],
    ...
    'coffee/missing-fat-arrows': ['warn', {
      is_strict: false
    }],
    'coffee/newlines-after-classes': ['off', {
      value: 2
    }],
    'coffee/no-debugger': ['warn', {
      console: true
    }],
    'coffee/no-empty-functions': ['off', {}],
    'coffee/no-empty-param-list': ['off', {}],
    'coffee/no-implicit-braces': ['off', {
      warn: true
    }],
    'coffee/no-implicit-parens': ['off', {
      warn: true
    }],
